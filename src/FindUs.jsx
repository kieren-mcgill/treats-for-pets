...
const FindUs = () => {
  return (
    <div id="findUs">
      ...
      <div
        className="w-100 h-100 bg-light d-flex flex-column flex-md-row justify-content-center align-items-center pt-5 pb-5">
        <div className="display-el">
          <Map/>
        </div>
        <div className="display-el d-flex flex-column align-items-center justify-content-center"
             style={{ lineHeight: "2", backgroundColor: '#F8F6E7FF' }}>
      ...
      <div className="d-flex flex-row justify-content-center"
           style={{ backgroundColor: '#F8F6E7FF' }}>
